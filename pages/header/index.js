        ...
        <header className="d-flex align-items-center">
            <div className="d-flex w-75 mx-auto align-items-center">
                ...
                <ul className="d-flex flex-grow-1 mt-2 align-items-center justify-content-end">
                    ...
                    <li>
                        <Link href="/contact">
                            <a className="nav-url text-white">Contact</a>
                        </Link>
                    </li>
                    <a href="https://github.com/erenustun/" className="ml-4 mb-2" target="_blank"><img src="/assets/images/github.png" height={26} /></a>
